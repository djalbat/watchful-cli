...
const BABEL_NOT_INSTALLED = "The '@babel/core' package is not installed.",
      ...
      BUNDLED_METRIC_MESSAGE = "Bundled in ${seconds} seconds.",
      TRANSFORM_FAILED_MESSAGE = "Babel failed:",
      TRANSPILED_METRIC_MESSAGE = "Transpiled in ${seconds} seconds.",
...
module.exports = {
  ...
  BUNDLED_METRIC_MESSAGE,
  TRANSFORM_FAILED_MESSAGE,
  TRANSPILED_METRIC_MESSAGE,
